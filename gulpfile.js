/* Reference: https://ahmadawais.com/my-advanced-gulp-workflow-for-wordpress-themes/ */

// Project configuration
var project 		= 'mrTandCoffee', // Project name, used for build zip.
	url 			= 'mrTandCoffee.dev', // Local Development URL for BrowserSync. Change as-needed.
...
/* Scripts: Vendors - meaning: a person or company offering something for sale, especially a trader in the street.
...
/* Images - Look at src/images, optimize the images and send them to the appropriate place
========================================================================================= */
...
/* Building a Clean Installable Theme Zip File - Clean gulp cache
================================================================ */
...
/* Gulp Default Task - Compiles styles, fires-up browser sync, watches js and php files. Note browser sync task watches php files
==============================*/
